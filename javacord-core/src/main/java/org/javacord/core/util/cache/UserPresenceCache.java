...
public class UserPresenceCache {
    ...
    private UserPresenceCache(final Cache<UserPresence> cache) {
        this.cache = cache;
    }
     ...
     */
    public UserPresenceCache addUserPresence(final UserPresence presence) {
     ...
     * @return The new user presence cache.
     */
    public UserPresenceCache removeUserPresence(final UserPresence presence) {
        if (presence == null) {
            return this;
        }
     ...
     */
    public Optional<UserPresence> getPresenceByUserId(final long userId) {
